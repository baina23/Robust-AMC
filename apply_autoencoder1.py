...
# eps_values = np.array([0.00, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 
#                        0.35, 0.4, 0.45, 0.50])
...
encoder = AUTOENCODER()
encoder.load_state_dict(torch.load("AUTOENCODER_sub12.pt"))
encoder.to(device)
...
eps_values_T = np.array([0.001, 0.003, 0.005, 0.007 ])
